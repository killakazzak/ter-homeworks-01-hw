...
```bash
cd ter-homeworks-01-hw/01/mysql/
tofu init
```
![image](https://github.com/user-attachments/assets/a666df89-2118-4344-bf3f-cd42f44ffa7d)

```bash
tofu validate
```
![image](https://github.com/user-attachments/assets/cd0e9e08-a7c2-467a-9ef8-162df968f0f6)

```bash
tofu apply
```
![image](https://github.com/user-attachments/assets/73f3fc8e-5199-4afb-a3fc-ddf3292ca5c0)

```bash
docker exec -it mysql env
```

![image](https://github.com/user-attachments/assets/16d0bacd-d550-446c-8a30-e688e3d3eb1a)

```bash
tofu destroy
```
![image](https://github.com/user-attachments/assets/87abe1b8-ab4b-484c-ae46-1641ee64b5f6)
